...
export function NotebooksStep({
  ...
  return (
    <div className="space-y-6">
      <FormSection
        title="Pilih Buku Catatan (opsional)"
        description="Pilih buku catatan mana yang harus berisi sumber ini. Anda dapat memilih beberapa buku catatan atau membiarkannya kosong."
      >
        <CheckboxList
          items={notebookItems}
          ...
          loading={loading}
          emptyMessage="Tidak ada buku catatan ditemukan."
        />
      </FormSection>
    </div>
  )
