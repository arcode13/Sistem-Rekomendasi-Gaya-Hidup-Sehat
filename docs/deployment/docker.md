...
- Works with documents (PDF, EPUB, Office), Markdown/plain text, and images (JPG/PNG)
...
3. Add a description
4. Click **"Create"**
5. Add your first source (document/image upload or direct text)
...
2. **Explore features** - Try transformations, chat, and search
