...
- 🤖 **Choose your AI models** - Support for OpenAI, Google (Gemini), and Ollama
- 📚 **Organize research content** - PDFs, Office docs, EPUB, Markdown, images, and text
...
| **AI Provider Choice** | OpenAI, Google (Gemini), Ollama | Google models only | Flexibility and cost optimization |
...
- 💬 **Flexible Chat & Context**: Full control over AI context vs limited 2-speaker deep-dive format
...
- **📚 Universal Content Support**: PDFs, Office docs, EPUB, Markdown, images (JPG/PNG), and text
