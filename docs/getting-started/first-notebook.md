...
## Step 1: Accessing Your Notebook

Open Notebook uses a single notebook approach. Your notebook is automatically available when you access the Notebooks page.

1. **Navigate to Notebooks**: Click **📒 Notebooks** in the sidebar
2. **Automatic Access**: The system automatically opens your notebook
3. **View Notebook Info**: The notebook header shows update timestamp, source count, and note count
...
3. **Enter a title** like "Research Notes"
4. **Paste or type your content**
5. **Click "Done"**

The system will process the content and make it available for AI interactions.
...
3. **Descriptive Naming**: Give your sources clear, searchable titles
