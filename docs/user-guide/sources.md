...
Open Notebook focuses on high-quality document processing.
...
- **Text files** - Plain text (.txt) and Markdown (.md)

### 🖼️ Images
- **JPG, JPEG, PNG** - With OCR text recognition for scanned documents or screenshots
...
**Supported formats:**
- Documents: PDF, DOC/DOCX, PPT/PPTX, XLS/XLSX, EPUB, TXT, MD
- Images: JPG, JPEG, PNG (with OCR)

### Method 2: Adding Text Content
...
### Processing Workflow
1. **Upload or text submission** - Source is received
...
2. **Include relevant articles** (document uploads)
...
1. **Upload course materials** (PDFs, slides, worksheets)
2. **Add supplementary articles** (document uploads)
