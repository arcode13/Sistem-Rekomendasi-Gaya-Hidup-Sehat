...
# Install dependencies - npm ci installs optional dependencies by default
# If that fails, fall back to npm install which handles optional deps more reliably
RUN npm ci || npm install
# Ensure all native modules are properly built for this platform
